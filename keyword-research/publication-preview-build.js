...
/**
 * @param {{ sourceRunDir: string, publicationApprovedFilePath: string, enrichmentRunDir: string }} options
 * @returns {Promise<{
 ...
 * }>}
 */
export async function buildPublicationPreview({ sourceRunDir, publicationApprovedFilePath, enrichmentRunDir }) {
