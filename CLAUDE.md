...
**個人の発信の扱い方(2026-08-19追加)**: 個人のブログ・SNS投稿等の意見が、公的データ・論文・パブリックコメントと異なるのは当然のことであり、それ自体を「誤り」と断定しない。個人の意見は一つのサンプルとして扱い、公的な情報源と突き合わせて全体像を俯瞰した上で整合性を判断すること。法律に関わる可能性がある内容は、調査手法の一部として毎回必ず法的観点(景品表示法・薬機法・特定商取引法等、該当する場合)も確認する。
